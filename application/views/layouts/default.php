	...
	<div class="kt-grid kt-grid--hor kt-grid--root">
		<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
			...
			<div class="kt-aside kt-aside--fixed  kt-grid__item kt-grid kt-grid--desktop kt-grid--hor-desktop"
				id="kt_aside">
				<!-- begin:: Aside -->
				<div style="border-bottom: 1px solid #2d2d43; height: 74px;" class="kt-aside__brand kt-grid__item "
					id="kt_aside_brand">
						...
						<div>
							...
							<ul class="kt-menu__nav ">
								...
								<li class="kt-menu__section ">
									<h4 class="kt-menu__section-text">Expenses Authorization</h4>
								...
								<li class="kt-menu__item  kt-menu__item--submenu <?= ($pageParent == 'Outgoing Requests' ? 'kt-menu__item--open' : '') ?>"
									aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;"
										...
										<span class="kt-menu__link-text">Outgoing Requests</span><i
											class="kt-menu__ver-arrow la la-angle-right"></i></a>
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
											<li class="kt-menu__item  kt-menu__item--parent" aria-haspopup="true"><span
									...
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
											...
											<li class="kt-menu__item <?= ($page == 'Pending report' ? 'kt-menu__item--active' : '') ?>"
												aria-haspopup="true">
												<a href="<?= base_url('ea_report/incoming/pending') ?>"
													class="kt-menu__link"><i
														class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
														class="kt-menu__link-text">
														Pending</span>
											...
											<?php if (is_finance_teams() ||$this->user_data->username == 'root'): ?>
											<li class="kt-menu__item <?= ($page == 'Refund/reimburst report' ? 'kt-menu__item--active' : '') ?>"
												aria-haspopup="true">
												<a href="<?= base_url('ea_report/incoming/refund_reimburst') ?>"
													class="kt-menu__link"><i
														class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
														class="kt-menu__link-text">
														Refund/reimburst</span>
												</a>
											</li>
											<?php endif; ?>
											<li class="kt-menu__item <?= ($page == 'Done report' ? 'kt-menu__item--active' : '') ?>"
												aria-haspopup="true">
												<a href="<?= base_url('ea_report/incoming/done') ?>"
													class="kt-menu__link"><i
														class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
														class="kt-menu__link-text">
														Done</span>
								...
								<li class="kt-menu__item  kt-menu__item--submenu <?= ($pageParent == 'Outgoing report' ? 'kt-menu__item--open' : '') ?>"
									...
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
											...
											<li class="kt-menu__item <?= ($page == 'Pending report' ? 'kt-menu__item--active' : '') ?>"
												aria-haspopup="true">
												<a href="<?= base_url('ea_report/outgoing/pending') ?>"
													class="kt-menu__link"><i
														class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
														class="kt-menu__link-text">
														Pending</span>
											...
											<li class="kt-menu__item <?= ($page == 'Approved report' ? 'kt-menu__item--active' : '') ?>"
												aria-haspopup="true">
												<a href="<?= base_url('ea_report/outgoing/approved') ?>"
													class="kt-menu__link"><i
														class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
														class="kt-menu__link-text">
														Approved</span>
											...
											<li class="kt-menu__item <?= ($page == 'Rejected report' ? 'kt-menu__item--active' : '') ?>"
												aria-haspopup="true">
												<a href="<?= base_url('ea_report/outgoing/rejected') ?>"
													class="kt-menu__link"><i
														class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
														class="kt-menu__link-text">
														Rejected</span>
											...
											<li class="kt-menu__item <?= ($page == 'Refund/reimburst report' ? 'kt-menu__item--active' : '') ?>"
												aria-haspopup="true">
												<a href="<?= base_url('ea_report/outgoing/refund_reimburst') ?>"
													class="kt-menu__link"><i
														class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
														class="kt-menu__link-text">
														Refund/reimburst</span>
											...
											<li class="kt-menu__item <?= ($page == 'Done report' ? 'kt-menu__item--active' : '') ?>"
												aria-haspopup="true">
												<a href="<?= base_url('ea_report/outgoing/done') ?>"
													class="kt-menu__link"><i
														class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span
														class="kt-menu__link-text">
														Done</span>
